        ...
        <div className={"flex flex-col flex-grow min-h-screen overflow-y-scroll items-center"}>
          <div className="max-w-lg flex-grow">
            ...
            <div className="flex flex-grow justify-center max-h-52 mt-10">
              <img className={"flex-grow"} src={"/logos/DHBW_StuV_MOS_Zeichen_rgb.svg"} />
            </div>

            <div className="container mx-auto text-center pt-5">
              <h1 className={"text-gray-50 font-light text-5xl"}>Herzlich willkommen an der DHBW Mosbach!</h1>
              <h2 className={"text-gray-50 font-light text-2xl mt-5"}>In folgendem haben wir euch einmal die wichtigsten Links für euren Studienstart zusammengefasst.</h2>
...
{/*                <a href={"https://chat.whatsapp.com/GeSZ7EFMilBKoRU2DsokWw"} target={"_blank"} className={"p-3 border border-2 border-[#25D366] hover:bg-[#25D366] hover:bg-opacity-30 cursor-pointer rounded-lg flex items-center gap-4"}>
                ...
                <a href={"https://discord.gg/mhtR7Q3D8W"} target={"_blank"} className={"p-3 border border-2 border-[#5865F2] hover:bg-[#5865F2] hover:bg-opacity-30 cursor-pointer rounded-lg flex items-center gap-4"}>
                  <svg className={"h-10 w-10 text-white flex-grow-0"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 71 55" fill="none">
                  ...
                  <div className={"text-2xl text-gray-50 flex-grow"}>DHBW Mosbach Discord</div>
                </a>
